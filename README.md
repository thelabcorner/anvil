...
A separate Grotli-derived representation lane has now produced ANVIL's first clean **same-backend structured representation crossing**: on the frozen CROVIA receipt corpus, byte-exact lexical shape/column reordering followed by the same Brotli q11/lgwin30 backend is **21.77% smaller than raw Brotli**. The broader untyped G1 gate is still a **NO-GO**—only one discovery family crossed 5%, and the routed four-family portfolio improved by 1.656%, below the preregistered 3% threshold. G2's typed basis also missed its broad gate, while G3 regionization passed discovery at **-5.5984%** aggregate but failed its independent DrugQA held-out test at **+3.1900% worse than raw Brotli**, closing as **PASS-G3-NARROW**.
...
- [`docs/I10-GROTLI-G2-RESULTS.md`](docs/I10-GROTLI-G2-RESULTS.md) — G2 typed-column closeout: broad discovery NO-GO despite strong D2/D4 specialist wins
- [`docs/I10-GROTLI-G3-REGION-PREREG.md`](docs/I10-GROTLI-G3-REGION-PREREG.md) and [`docs/I10-GROTLI-G3-RESULTS.md`](docs/I10-GROTLI-G3-RESULTS.md) — regionized representation: discovery pass, held-out **PASS-G3-NARROW**
- [`docs/I10-GROTLI-G4-PLANNER-FIDELITY-PREREG.md`](docs/I10-GROTLI-G4-PLANNER-FIDELITY-PREREG.md) and [`docs/I10-GROTLI-G4-RESULTS.md`](docs/I10-GROTLI-G4-RESULTS.md) — cheap planner-proxy hypothesis closed **NO-GO-G4**
- [`docs/I10-GROTLI-G5A-ORDERING-ATTRIBUTION-PREREG.md`](docs/I10-GROTLI-G5A-ORDERING-ATTRIBUTION-PREREG.md) and [`docs/I10-GROTLI-G5A-RESULTS.md`](docs/I10-GROTLI-G5A-RESULTS.md) — same-multiset ordering attribution: **ORDER-MATERIAL / COLUMN-DOMINANT**
- [`docs/I10-GROTLI-G5B-ORDINAL-PREREG.md`](docs/I10-GROTLI-G5B-ORDINAL-PREREG.md) and [`docs/I10-GROTLI-G5B-ORDINAL-RESULTS.md`](docs/I10-GROTLI-G5B-ORDINAL-RESULTS.md) — global same-ordinal cross-shape proxy closed **ORDINAL-ADVERSE**
